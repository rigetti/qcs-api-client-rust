...
/// QdoSlowFluxChannel : Configuration for a QDO Slow Flux Channel Channel.
use serde::{Deserialize, Serialize};

#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct QdoSlowFluxChannel {
    #[serde(rename = "_type")]
    pub _type: String,
...
impl QdoSlowFluxChannel {
    /// Configuration for a QDO Slow Flux Channel Channel.
    pub fn new(_type: String, channel_index: i32) -> QdoSlowFluxChannel {
        QdoSlowFluxChannel {
            _type,
            channel_index,
            direction: None,
