...
pub struct InternalListLegacyQuantumProcessorsResponse {
    #[serde(rename = "legacyQuantumProcessors")]
    pub legacy_quantum_processors: Vec<crate::models::LegacyQuantumProcessor>,
    /// Send an opaque page token returned from a prior request
    #[serde(rename = "nextPageToken", skip_serializing_if = "Option::is_none")]
    pub next_page_token: Option<String>,
}

impl InternalListLegacyQuantumProcessorsResponse {
    pub fn new(legacy_quantum_processors: Vec<crate::models::LegacyQuantumProcessor>) -> InternalListLegacyQuantumProcessorsResponse {
        InternalListLegacyQuantumProcessorsResponse {
            legacy_quantum_processors,
