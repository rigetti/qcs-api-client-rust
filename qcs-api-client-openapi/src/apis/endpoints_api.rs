...
pub struct CreateEndpointClapParams {
    pub create_endpoint_parameters: JsonMaybeStdin<crate::models::CreateEndpointParameters>,
}
...
impl ListEndpointsClapParams {
    pub async fn execute(
        self,
        configuration: &configuration::Configuration,
    ) -> Result<models::ListEndpointsResponse, miette::Error> {
        list_endpoints(
            configuration,
...
pub struct RestartEndpointClapParams {
    #[arg(long)]
    pub endpoint_id: String,
    pub restart_endpoint_request: Option<JsonMaybeStdin<crate::models::RestartEndpointRequest>>,
}
...
async fn create_endpoint_inner(
    ...
    let p_body_create_endpoint_parameters = create_endpoint_parameters;
    ...
    local_var_req_builder = local_var_req_builder.json(&p_body_create_endpoint_parameters);
...
async fn list_endpoints_inner(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        match local_var_content_type {
            ...
            ContentType::Text => Err(Error::InvalidContentType {
                content_type: local_var_raw_content_type,
                return_type: "models::ListEndpointsResponse",
            }),
            ContentType::Unsupported(unknown_type) => Err(Error::InvalidContentType {
                content_type: unknown_type,
                return_type: "models::ListEndpointsResponse",
...
async fn restart_endpoint_inner(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_endpoint_id = endpoint_id;
    let p_body_restart_endpoint_request = restart_endpoint_request;
    ...
    local_var_req_builder = local_var_req_builder.json(&p_body_restart_endpoint_request);
