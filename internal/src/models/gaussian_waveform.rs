...
impl GaussianWaveform {
    /// Gaussian shaped waveform envelope defined for a specific frame.
    pub fn new(_type: String, detuning: f32, duration: f32, frame: String, fwhm: f32, phase: f32, scale: f32, t0: f32) -> GaussianWaveform {
        GaussianWaveform {
            _type,
            detuning,
            duration,
