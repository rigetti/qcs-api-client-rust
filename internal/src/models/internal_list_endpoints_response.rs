...
pub struct InternalListEndpointsResponse {
    #[serde(rename = "endpoints")]
    pub endpoints: Vec<crate::models::InternalEndpoint>,
    /// Opaque token indicating the start of the next page of results to return; do not decode
    #[serde(rename = "nextPageToken", skip_serializing_if = "Option::is_none")]
    pub next_page_token: Option<String>,
}

impl InternalListEndpointsResponse {
    pub fn new(endpoints: Vec<crate::models::InternalEndpoint>) -> InternalListEndpointsResponse {
