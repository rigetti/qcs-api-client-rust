...
/// RigettiDomainModelModelsScheduleIrInstructionParametersParameterSpec : Specification of a dynamic parameter type and array-length.
...
impl RigettiDomainModelModelsScheduleIrInstructionParametersParameterSpec {
    /// Specification of a dynamic parameter type and array-length.
    pub fn new(_type: String, _type: crate::models::ParameterType) -> RigettiDomainModelModelsScheduleIrInstructionParametersParameterSpec {
        RigettiDomainModelModelsScheduleIrInstructionParametersParameterSpec {
            _type,
            length: None,
            _type,
        }
