...
pub struct APyQuilCompilerIsa {
    #[serde(rename = "1Q", skip_serializing_if = "Option::is_none")]
    pub var_1_q: Option<::std::collections::HashMap<String, crate::models::Qubit>>,
    #[serde(rename = "2Q", skip_serializing_if = "Option::is_none")]
    pub var_2_q: Option<::std::collections::HashMap<String, crate::models::Edge>>,
}

impl APyQuilCompilerIsa {
    /// The ISA against which this program will execute
    pub fn new() -> APyQuilCompilerIsa {
        APyQuilCompilerIsa {
            var_1_q: None,
            var_2_q: None,
        }
