...
impl LegacyDeployedRack {
    pub fn new(_type: String, instruments: ::std::collections::HashMap<String, crate::models::Instrument>, qpu: crate::models::Qpu, rack_meta: crate::models::RackMeta) -> LegacyDeployedRack {
        LegacyDeployedRack {
            _type,
            instruments,
            qpu: Box::new(qpu),
