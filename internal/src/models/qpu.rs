...
pub struct Qpu {
    #[serde(rename = "_type")]
    pub _type: String,
    #[serde(rename = "chip_label")]
    pub chip_label: String,
    #[serde(rename = "controls")]
    pub controls: ::std::collections::HashMap<String, Vec<String>>,
    #[serde(rename = "controls_by_qubit")]
    pub controls_by_qubit: ::std::collections::HashMap<String, Vec<serde_json::Value>>,
    #[serde(rename = "qubits")]
    pub qubits: Vec<String>,
}

impl Qpu {
    /// Information about the topology of the device in relation to its control interfaces.
    pub fn new(_type: String, chip_label: String, controls: ::std::collections::HashMap<String, Vec<String>>, controls_by_qubit: ::std::collections::HashMap<String, Vec<serde_json::Value>>, qubits: Vec<String>) -> Qpu {
        Qpu {
            _type,
            chip_label,
            controls,
