...
pub struct AppApiTranslationModelsParameterSpec {
    #[serde(rename = "length", skip_serializing_if = "Option::is_none")]
    pub length: Option<i32>,
}

impl AppApiTranslationModelsParameterSpec {
    pub fn new() -> AppApiTranslationModelsParameterSpec {
        AppApiTranslationModelsParameterSpec { length: None }
    }
}
