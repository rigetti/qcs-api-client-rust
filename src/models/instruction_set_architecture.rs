...
pub struct InstructionSetArchitecture {
    ...
    pub architecture: Box<crate::models::Architecture1>,
...
impl InstructionSetArchitecture {
    ...
    pub fn new(architecture: crate::models::Architecture1, benchmarks: Vec<crate::models::Operation>, instructions: Vec<crate::models::Operation>, name: String) -> InstructionSetArchitecture {
