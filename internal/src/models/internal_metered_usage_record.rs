...
impl InternalMeteredUsageRecord {
    ...
    pub fn new(account_id: String, account_type: crate::models::AccountType, billing_usage_record_id: String, billing_usage_record_timestamp: String, created_time: String, creator_id: String, product: Product, quantity: i32, quantum_processor_id: String) -> InternalMeteredUsageRecord {
