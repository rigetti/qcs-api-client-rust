...
pub struct CompileQuilRequest {
    #[serde(rename = "isa")]
    pub isa: Box<crate::models::APyQuilCompilerIsa>,
    /// The number of randomized program parameter sets to produce
    #[serde(rename = "numRandomizations")]
    pub num_randomizations: i32,
    /// A list of compiler meta-passes to perform
    #[serde(rename = "passes")]
    pub passes: Vec<crate::models::MetaPass>,
    /// The Program to compile. Note, parametric programs are not currently supported.
    #[serde(rename = "program")]
    pub program: String,
}

impl CompileQuilRequest {
    pub fn new(
        isa: crate::models::APyQuilCompilerIsa,
        num_randomizations: i32,
        passes: Vec<crate::models::MetaPass>,
        program: String,
    ) -> CompileQuilRequest {
        CompileQuilRequest {
            isa: Box::new(isa),
