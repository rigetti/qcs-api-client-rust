...
impl BillingInvoice {
    ...
    pub fn new(period_end: String, period_start: String, starting_balance: i32, status: crate::models::BillingInvoiceStatus, subtotal: i32, tax: i32, total: i32, id: String) -> BillingInvoice {
        BillingInvoice {
            period_end,
            period_start,
            starting_balance,
