...
pub struct Instrument {
    ...
    pub mnio_connections: Option<::std::collections::HashMap<String, crate::models::MnioConnection>>,
    #[serde(rename = "module")]
    pub module: String,
    #[serde(rename = "setup")]
...
impl Instrument {
    ...
    pub fn new(_type: String, address: String, channels: ::std::collections::HashMap<String, crate::models::Channels>, instrument_type: crate::models::InstrumentType, module: String, setup: serde_json::Value) -> Instrument {
        Instrument {
            _type,
            address,
            channels,
