...
impl BillingUpcomingInvoice {
    /// An unfinalized billing invoice.
    pub fn new(period_end: String, period_start: String, starting_balance: i32, status: crate::models::BillingInvoiceStatus, subtotal: i32, tax: i32, total: i32) -> BillingUpcomingInvoice {
