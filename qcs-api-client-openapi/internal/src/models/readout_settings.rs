...
pub struct ReadoutSettings {
    ...
    pub classifier: Option<Box<crate::models::ReadoutClassifier>>,
    #[serde(rename = "program")]
    pub program: Box<crate::models::ScheduledProgram>,
}

impl ReadoutSettings {
    /// All information needed to perform readout for a single qubit.
    pub fn new(_type: String, program: crate::models::ScheduledProgram) -> ReadoutSettings {
        ReadoutSettings {
            _type,
            classifier: None,
