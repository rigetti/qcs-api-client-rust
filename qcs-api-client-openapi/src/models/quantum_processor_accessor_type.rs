...
/// QuantumProcessorAccessorType: Type of the accessor. Each accessor type is a different mechanism of accessing a QPU, each with their own benefits and/or drawbacks.
...
impl std::fmt::Display for QuantumProcessorAccessorType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::GatewayV1 => write!(f, "gateway.v1"),
            Self::DirectV1 => write!(f, "direct.v1"),
