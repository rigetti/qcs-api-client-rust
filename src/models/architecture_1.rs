...
impl Architecture1 {
    ...
    pub fn new(edges: Vec<crate::models::Edge>, family: Option<crate::models::Family>, nodes: Vec<crate::models::Node>) -> Architecture1 {
        Architecture1 {
            edges,
            family: if let Some(x) = family {Some(Box::new(x))} else {None},
            nodes,
        }
    }
}
