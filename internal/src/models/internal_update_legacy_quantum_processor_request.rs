...
pub struct InternalUpdateLegacyQuantumProcessorRequest {
    /// Legacy Quantum Processor Patch Update
    #[serde(rename = "legacyQuantumProcessor")]
    pub legacy_quantum_processor: serde_json::Value,
}

impl InternalUpdateLegacyQuantumProcessorRequest {
    pub fn new(legacy_quantum_processor: serde_json::Value) -> InternalUpdateLegacyQuantumProcessorRequest {
        InternalUpdateLegacyQuantumProcessorRequest {
            legacy_quantum_processor,
        }
    }
}
