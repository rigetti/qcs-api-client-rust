...
pub struct ListAccountBillingInvoiceLinesResponse {
    #[serde(rename = "billingInvoiceLines")]
    pub billing_invoice_lines: Vec<crate::models::BillingInvoiceLine>,
    #[serde(rename = "nextPageToken", skip_serializing_if = "Option::is_none")]
    pub next_page_token: Option<String>,
}

impl ListAccountBillingInvoiceLinesResponse {
    pub fn new(billing_invoice_lines: Vec<crate::models::BillingInvoiceLine>) -> ListAccountBillingInvoiceLinesResponse {
