...
pub enum ScheduledInstructionsInner {
    #[serde(rename = "Pulse")]
    Pulse(crate::models::Pulse),
    #[serde(rename = "FlatPulse")]
    FlatPulse(crate::models::FlatPulse),
    #[serde(rename = "SetFrequency")]
    SetFrequency(crate::models::SetFrequency),
    #[serde(rename = "ShiftFrequency")]
    ShiftFrequency(crate::models::ShiftFrequency),
    #[serde(rename = "SetPhase")]
    SetPhase(crate::models::SetPhase),
    #[serde(rename = "ShiftPhase")]
    ShiftPhase(crate::models::ShiftPhase),
    #[serde(rename = "SwapPhases")]
    SwapPhases(crate::models::SwapPhases),
    #[serde(rename = "SetScale")]
    SetScale(crate::models::SetScale),
    #[serde(rename = "Capture")]
    Capture(crate::models::Capture),
    #[serde(rename = "DebugMessage")]
    DebugMessage(crate::models::DebugMessage),
    #[serde(rename = "ActiveReset")]
    ActiveReset(crate::models::ActiveReset),
}
