...
/// Qgsx2Sequencer : Configuration for a single QGSx2 Sequencer.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct Qgsx2Sequencer {
    #[serde(rename = "_type")]
    pub _type: String,
    #[serde(rename = "sequencer_index", skip_serializing_if = "Option::is_none")]
    pub sequencer_index: Option<i32>,
...
impl Qgsx2Sequencer {
    ...
    pub fn new(_type: String, tx_channel: String) -> Qgsx2Sequencer {
        Qgsx2Sequencer {
            _type,
            sequencer_index: None,
            tx_channel,
        }
    }
}
