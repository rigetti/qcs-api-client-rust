...
pub struct InternalListLegacyLatticesResponse {
    #[serde(rename = "legacyLattices")]
    pub legacy_lattices: Vec<crate::models::LegacyLattice>,
    /// Send an opaque page token returned from a prior request
    #[serde(rename = "nextPageToken", skip_serializing_if = "Option::is_none")]
    pub next_page_token: Option<String>,
}

impl InternalListLegacyLatticesResponse {
    pub fn new(legacy_lattices: Vec<crate::models::LegacyLattice>) -> InternalListLegacyLatticesResponse {
