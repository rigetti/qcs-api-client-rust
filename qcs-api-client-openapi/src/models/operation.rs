...
pub struct Operation {
    ...
    pub characteristics: Vec<models::Characteristic>,
    ...
    #[serde(rename = "sites")]
    pub sites: Vec<models::OperationSite>,
}

impl Operation {
    /// An operation, with its sites and site-independent characteristics.
    pub fn new(
        characteristics: Vec<models::Characteristic>,
        name: String,
        parameters: Vec<models::Parameter>,
        sites: Vec<models::OperationSite>,
    ) -> Operation {
        Operation {
            characteristics,
            name,
