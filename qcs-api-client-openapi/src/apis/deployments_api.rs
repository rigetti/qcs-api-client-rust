...
/// Serialize command-line arguments for [`get_endpoint_accessors`]
#[cfg(feature = "clap")]
#[derive(Debug, clap::Args)]
pub struct GetEndpointAccessorsClapParams {
    #[arg(long)]
    pub endpoint_id: String,
}

#[cfg(feature = "clap")]
impl GetEndpointAccessorsClapParams {
    pub async fn execute(
        self,
        configuration: &configuration::Configuration,
    ) -> Result<models::ListQuantumProcessorAccessorsResponse, miette::Error> {
        get_endpoint_accessors(configuration, self.endpoint_id.as_str())
            .await
            .into_diagnostic()
    }
}

/// struct for typed errors of method [`get_endpoint_accessors`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetEndpointAccessorsError {
    Status422(models::ValidationError),
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}

async fn get_endpoint_accessors_inner(
    configuration: &configuration::Configuration,
    backoff: &mut ExponentialBackoff,
    endpoint_id: &str,
) -> Result<models::ListQuantumProcessorAccessorsResponse, Error<GetEndpointAccessorsError>> {
    ...
    let local_var_uri_str = format!(
        "{}/v1/endpoints/{endpoint_id}/accessors",
    ...
    #[cfg(feature = "tracing")]
    {
        ...
        if local_var_do_tracing {
            ::tracing::debug!(
                ...
                method="GET",
                "making get_endpoint_accessors request",
            );
        }
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text().await?;
        let local_var_entity: Option<GetEndpointAccessorsError> =
...
pub async fn get_endpoint_accessors(
    configuration: &configuration::Configuration,
    endpoint_id: &str,
) -> Result<models::ListQuantumProcessorAccessorsResponse, Error<GetEndpointAccessorsError>> {
    ...
    loop {
        let result =
            get_endpoint_accessors_inner(configuration, &mut backoff, endpoint_id.clone()).await;
