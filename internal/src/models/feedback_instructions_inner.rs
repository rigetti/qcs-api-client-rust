...
pub struct FeedbackInstructionsInner {
    #[serde(rename = "_type")]
    pub _type: String,
...
impl FeedbackInstructionsInner {
    pub fn new(_type: String, detuning: f32, frame: String, phase: f32, scale: f32, time: f32, waveform: String, duration: f32, iq: Vec<f32>, frequency: f32, delta: crate::models::Delta, frame_a: String, frame_b: String, filters: Vec<String>, send_to_host: bool, message: i32) -> FeedbackInstructionsInner {
        FeedbackInstructionsInner {
            _type,
            detuning,
            frame,
            phase,
