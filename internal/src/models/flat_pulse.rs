...
impl FlatPulse {
    /// Play a pulse with a constant complex amplitude.  This pulse is not derived from a waveform and admits the imposition of a scale, phase, and detuning.
    pub fn new(_type: String, detuning: f32, duration: f32, frame: String, iq: Vec<f32>, phase: f32, scale: f32, time: f32) -> FlatPulse {
        FlatPulse {
            _type,
            detuning,
            duration,
