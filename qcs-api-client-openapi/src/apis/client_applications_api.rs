...
impl CheckClientApplicationClapParams {
    ...
    ) -> Result<models::CheckClientApplicationResponse, miette::Error> {
        let request = self
...
impl GetClientApplicationClapParams {
    pub async fn execute(
        self,
        configuration: &configuration::Configuration,
    ) -> Result<models::ClientApplication, miette::Error> {
...
impl ListClientApplicationsClapParams {
    pub async fn execute(
        self,
        configuration: &configuration::Configuration,
    ) -> Result<models::ListClientApplicationsResponse, miette::Error> {
...
async fn check_client_application_inner(
    ...
    let p_body_check_client_application_request = check_client_application_request;
    ...
    local_var_req_builder = local_var_req_builder.json(&p_body_check_client_application_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        match local_var_content_type {
            ...
            ContentType::Text => Err(Error::InvalidContentType {
                ...
                return_type: "models::CheckClientApplicationResponse",
            }),
...
async fn get_client_application_inner(
    ...
    let local_var_configuration = configuration;
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_client_application_name = client_application_name;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.qcs_config.api_url(),
        clientApplicationName = crate::apis::urlencode(p_path_client_application_name)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        match local_var_content_type {
            ...
            ContentType::Text => Err(Error::InvalidContentType {
                content_type: local_var_raw_content_type,
                return_type: "models::ClientApplication",
            }),
            ContentType::Unsupported(unknown_type) => Err(Error::InvalidContentType {
                content_type: unknown_type,
                return_type: "models::ClientApplication",
...
async fn list_client_applications_inner(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        match local_var_content_type {
            ...
            ContentType::Text => Err(Error::InvalidContentType {
                content_type: local_var_raw_content_type,
                return_type: "models::ListClientApplicationsResponse",
            }),
            ContentType::Unsupported(unknown_type) => Err(Error::InvalidContentType {
                content_type: unknown_type,
                return_type: "models::ListClientApplicationsResponse",
