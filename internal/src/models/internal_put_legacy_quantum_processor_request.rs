...
pub struct InternalPutLegacyQuantumProcessorRequest {
    #[serde(rename = "legacyQuantumProcessor")]
    pub legacy_quantum_processor: Box<crate::models::LegacyQuantumProcessor>,
}

impl InternalPutLegacyQuantumProcessorRequest {
    pub fn new(legacy_quantum_processor: crate::models::LegacyQuantumProcessor) -> InternalPutLegacyQuantumProcessorRequest {
        InternalPutLegacyQuantumProcessorRequest {
            legacy_quantum_processor: Box::new(legacy_quantum_processor),
        }
    }
}
