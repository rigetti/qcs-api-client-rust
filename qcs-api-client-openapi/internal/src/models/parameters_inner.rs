...
/// Autogenerated `oneOf` implementation of `Parameters_inner`.
///
/// # Default impl
///
...
/// `ParametersInner::String`.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(untagged, deny_unknown_fields)]
pub enum ParametersInner {
    String(String),
    F32(f32),
}

impl From<String> for ParametersInner {
    fn from(variant: String) -> Self {
        Self::String(variant)
    }
}
impl From<f32> for ParametersInner {
    fn from(variant: f32) -> Self {
        Self::F32(variant)
    }
}

impl Default for ParametersInner {
    fn default() -> Self {
        Self::String(String::default())
    }
}

impl ParametersInner {
