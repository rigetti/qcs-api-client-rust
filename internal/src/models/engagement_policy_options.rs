...
pub struct EngagementPolicyOptions {
    ...
    #[serde(rename = "alternateQuantumProcessorIds", skip_serializing_if = "Option::is_none")]
    pub alternate_quantum_processor_ids: Option<Vec<String>>,
    #[serde(rename = "onDemand", skip_serializing_if = "Option::is_none")]
    pub on_demand: Option<bool>,
    #[serde(rename = "onDemandProtectedUserIds", skip_serializing_if = "Option::is_none")]
    pub on_demand_protected_user_ids: Option<Vec<String>>,
}

impl EngagementPolicyOptions {
    /// Options for configuration of the selected engagement policy
    pub fn new() -> EngagementPolicyOptions {
        EngagementPolicyOptions {
            alternate_quantum_processor_ids: None,
            on_demand: None,
            on_demand_protected_user_ids: None,
        }
    }
}
