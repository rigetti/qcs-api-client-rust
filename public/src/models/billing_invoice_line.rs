...
impl BillingInvoiceLine {
    ...
    pub fn new(amount: i32, description: String, id: String, line_item_type: LineItemType, metadata: ::std::collections::HashMap<String, String>, quantity: i32) -> BillingInvoiceLine {
        BillingInvoiceLine {
            amount,
            description,
            id,
