...
pub mod translation_options {
    #[derive(
        ...
        Eq,
        Hash,
        ::qcs_dependencies_client::prost::Message
    )]
    #[prost(prost_path = "::qcs_dependencies_client::prost")]
    pub struct QCtrl {
    ...
    pub struct Riverlane {
        ...
        pub qeci_configuration_data: ::std::collections::HashMap<
            ...
            ::qcs_dependencies_client::prost::alloc::vec::Vec<u8>,
        >,
    ...
    /// If neither is specified, the implementing service may select the
    /// translation backend and options.
    #[derive(Clone, Copy, PartialEq, ::qcs_dependencies_client::prost::Oneof)]
    #[prost(prost_path = "::qcs_dependencies_client::prost")]
...
#[derive(Clone, Copy, PartialEq, ::qcs_dependencies_client::prost::Message)]
#[prost(prost_path = "::qcs_dependencies_client::prost")]
...
pub struct TranslateQuilToEncryptedControllerJobRequest {
    #[prost(string, tag = "1")]
    pub quantum_processor_id: ::qcs_dependencies_client::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub quil_program: ::qcs_dependencies_client::prost::alloc::string::String,
...
pub mod translate_quil_to_encrypted_controller_job_request {
    #[derive(Clone, Copy, PartialEq, Eq, Hash, ::qcs_dependencies_client::prost::Oneof)]
    #[prost(prost_path = "::qcs_dependencies_client::prost")]
    pub enum NumShots {
        #[prost(uint32, tag = "3")]
        NumShotsValue(u32),
...
pub struct QuantumProcessorQuilCalibrationProgram {
    ...
    #[prost(string, tag = "1")]
    pub quil_calibration_program: ::qcs_dependencies_client::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, Eq, Hash, ::qcs_dependencies_client::prost::Message)]
#[prost(prost_path = "::qcs_dependencies_client::prost")]
...
pub mod translation_client {
    ...
    impl TranslationClient<qcs_dependencies_client::tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn translate_quil_to_encrypted_controller_job(
            &mut self,
            request: impl qcs_dependencies_client::tonic::IntoRequest<
                super::TranslateQuilToEncryptedControllerJobRequest,
            >,
        ) -> std::result::Result<
            qcs_dependencies_client::tonic::Response<super::TranslateQuilToEncryptedControllerJobResponse>,
        ...
        pub async fn get_quantum_processor_quil_calibration_program(
            ...
            qcs_dependencies_client::tonic::Response<super::QuantumProcessorQuilCalibrationProgram>,
            qcs_dependencies_client::tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod translation_server {
    ...
    pub trait Translation: std::marker::Send + std::marker::Sync + 'static {
        async fn translate_quil_to_encrypted_controller_job(
            &self,
            request: qcs_dependencies_client::tonic::Request<super::TranslateQuilToEncryptedControllerJobRequest>,
        ) -> std::result::Result<
            qcs_dependencies_client::tonic::Response<super::TranslateQuilToEncryptedControllerJobResponse>,
            qcs_dependencies_client::tonic::Status,
        >;
    ...
    impl<T, B> qcs_dependencies_client::tonic::codegen::Service<http::Request<B>> for TranslationServer<T>
    where
        T: Translation,
    ...
    impl<T> qcs_dependencies_client::tonic::server::NamedService for TranslationServer<T> {
