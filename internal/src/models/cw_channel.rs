...
/// CwChannel : Configuration for a single CW Generator Channel.
...
pub struct CwChannel {
    #[serde(rename = "_type")]
    pub _type: String,
    #[serde(rename = "channel_index", skip_serializing_if = "Option::is_none")]
...
impl CwChannel {
    ...
    pub fn new(_type: String) -> CwChannel {
        CwChannel {
            _type,
            channel_index: None,
