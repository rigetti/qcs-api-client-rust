...
pub struct InternalCreateMeteredUsageRecordRequest {
...
impl InternalCreateMeteredUsageRecordRequest {
    pub fn new(product: Product, quantity: i64, quantum_processor_id: String) -> InternalCreateMeteredUsageRecordRequest {
