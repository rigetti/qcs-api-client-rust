...
pub struct BillingPrice {
    ...
    pub billing_scheme: Option<models::BillingPriceScheme>,
    ...
    pub product: Option<models::BillingProduct>,

    #[serde(rename = "recurring", skip_serializing_if = "Option::is_none")]
    pub recurring: Option<models::BillingPriceRecurrence>,
    ...
    pub tiers: Option<Vec<models::BillingPriceTier>>,

    #[serde(rename = "tiersMode", skip_serializing_if = "Option::is_none")]
    pub tiers_mode: Option<models::BillingPriceTiersMode>,
