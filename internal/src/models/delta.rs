...
pub struct Delta {
    ...
    pub _type: String,
    #[serde(rename = "a")]
    pub a: Box<crate::models::A>,
    #[serde(rename = "b")]
    pub b: Box<crate::models::B>,
    #[serde(rename = "operator")]
    pub operator: crate::models::ParameterOperator,
    #[serde(rename = "index")]
    pub index: i32,
    #[serde(rename = "name")]
    pub name: String,
...
impl Delta {
    pub fn new(_type: String, a: crate::models::A, b: crate::models::B, operator: crate::models::ParameterOperator, index: i32, name: String) -> Delta {
        Delta {
            _type,
            a: Box::new(a),
            b: Box::new(b),
