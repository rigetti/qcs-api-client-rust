...
impl CreateEngagementClapParams {
    ...
    ) -> Result<models::EngagementWithCredentials, miette::Error> {
...
async fn create_engagement_inner(
    ...
    let p_body_create_engagement_request = create_engagement_request;
    ...
    local_var_req_builder = local_var_req_builder.json(&p_body_create_engagement_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        match local_var_content_type {
            ...
            ContentType::Text => Err(Error::InvalidContentType {
                ...
                return_type: "models::EngagementWithCredentials",
            }),
