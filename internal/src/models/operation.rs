...
impl Operation {
    ...
    pub fn new(characteristics: Vec<crate::models::Characteristic>, name: String, parameters: Vec<crate::models::Parameter>, sites: Vec<crate::models::OperationSite>) -> Operation {
        Operation {
            characteristics,
            name,
            node_count: None,
