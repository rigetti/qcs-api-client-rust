...
pub enum Filters {
    #[serde(rename = "BoxcarAveragerReadoutKernel")]
    BoxcarAveragerReadoutKernel(crate::models::BoxcarAveragerReadoutKernel),
    #[serde(rename = "FlatReadoutKernel")]
    FlatReadoutKernel(crate::models::FlatReadoutKernel),
    #[serde(rename = "ArbitraryReadoutKernel")]
    ArbitraryReadoutKernel(crate::models::ArbitraryReadoutKernel),
}
