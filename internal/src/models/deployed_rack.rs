...
impl DeployedRack {
    /// Describes the control configuration of a fridge/rack, real or fake.
    pub fn new(_type: String, instruments: ::std::collections::HashMap<String, crate::models::Instrument>, qpu: crate::models::Qpu, rack_meta: crate::models::RackMeta) -> DeployedRack {
        DeployedRack {
            _type,
            instruments,
            qpu: Box::new(qpu),
