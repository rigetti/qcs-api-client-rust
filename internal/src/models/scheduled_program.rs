...
pub struct ScheduledProgram {
    ...
    pub parameters: Option<::std::collections::HashMap<String, crate::models::RigettiDomainModelModelsScheduleIrInstructionParametersParameterSpec>>,
    #[serde(rename = "scheduled_instructions", skip_serializing_if = "Option::is_none")]
    pub scheduled_instructions: Option<Vec<crate::models::ScheduledInstructionsInner>>,
    #[serde(rename = "waveforms", skip_serializing_if = "Option::is_none")]
    pub waveforms: Option<::std::collections::HashMap<String, crate::models::Waveforms>>,
}

impl ScheduledProgram {
    /// Scheduled program made of ScheduledInstructions.  The ScheduledInstructions contain references to the waveforms, readout kernels, and parameters.
    pub fn new() -> ScheduledProgram {
        ScheduledProgram {
            _type: None,
            filters: None,
            parameters: None,
