...
pub enum MetaPass {
    ...
    #[serde(rename = "native")]
    Native,
    #[serde(rename = "rc_local")]
    RcLocal,
    #[serde(rename = "rc_global")]
    RcGlobal,
    #[serde(rename = "readout_symmetrization")]
    ReadoutSymmetrization,
}

impl std::fmt::Display for MetaPass {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Address => write!(f, "address"),
            Self::Swap => write!(f, "swap"),
            Self::Native => write!(f, "native"),
            Self::RcLocal => write!(f, "rc_local"),
            Self::RcGlobal => write!(f, "rc_global"),
            Self::ReadoutSymmetrization => write!(f, "readout_symmetrization"),
        }
    }
}

impl Default for MetaPass {
    fn default() -> MetaPass {
        Self::Address
    }
}
