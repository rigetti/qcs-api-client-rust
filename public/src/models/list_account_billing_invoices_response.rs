...
pub struct ListAccountBillingInvoicesResponse {
    #[serde(rename = "billingInvoices")]
    pub billing_invoices: Vec<crate::models::BillingInvoice>,
    #[serde(rename = "nextPageToken", skip_serializing_if = "Option::is_none")]
    pub next_page_token: Option<String>,
}

impl ListAccountBillingInvoicesResponse {
    pub fn new(billing_invoices: Vec<crate::models::BillingInvoice>) -> ListAccountBillingInvoicesResponse {
