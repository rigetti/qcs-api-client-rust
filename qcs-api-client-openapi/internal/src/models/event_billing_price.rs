...
/// EventBillingPrice : Associates a set of QCS entities (account, service product, quantum processor) with a particular `BillingPrice`.
...
pub struct EventBillingPrice {
    ...
    /// The quantum processor that this `EventBillingPrice` applies to. If unset, this `EventBillingPrice` can apply to any quantum processor.
