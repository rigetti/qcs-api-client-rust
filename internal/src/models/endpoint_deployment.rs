...
pub struct EndpointDeployment {
    ...
    pub component_addresses: ::std::collections::HashMap<String, ::std::collections::HashMap<String, String>>,
    /// The status of each of the endpoint's services
    #[serde(rename = "componentStatuses")]
    pub component_statuses: ::std::collections::HashMap<String, String>,
...
impl EndpointDeployment {
    /// The live, deployed configuration of an endpoint
    pub fn new(component_addresses: ::std::collections::HashMap<String, ::std::collections::HashMap<String, String>>, component_statuses: ::std::collections::HashMap<String, String>, healthy: bool) -> EndpointDeployment {
        EndpointDeployment {
            component_addresses,
            component_statuses,
            datacenter: None,
