...
pub struct ListEventBillingPricesResponse {
    #[serde(rename = "eventBillingPrices")]
    pub event_billing_prices: Vec<crate::models::EventBillingPrice>,
    #[serde(rename = "nextPageToken", skip_serializing_if = "Option::is_none")]
    pub next_page_token: Option<String>,
}

impl ListEventBillingPricesResponse {
    pub fn new(event_billing_prices: Vec<crate::models::EventBillingPrice>) -> ListEventBillingPricesResponse {
