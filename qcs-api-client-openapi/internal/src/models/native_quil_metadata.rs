...
pub struct NativeQuilMetadata {
    /// A list mapping logical to physical qubits. Indices represent logical qubits; list values indicate physical qubits.
    #[serde(rename = "finalRewiring")]
    pub final_rewiring: Vec<i32>,
}

impl NativeQuilMetadata {
    /// The native Quil metadata for the compilation.
    pub fn new(final_rewiring: Vec<i32>) -> NativeQuilMetadata {
