...
pub struct EndpointTemplate {
    ...
    /// A human-readable description for the template use case
    #[serde(rename = "description")]
    pub description: String,
    /// The name used to apply this template to a new or existing endpoint
    #[serde(rename = "name")]
    pub name: String,
}

impl EndpointTemplate {
    /// An EndpointTemplate is used to apply a set of default values to an endpoint on construction or update.  Note that there is no difference between using a template by name and using its component parameters directly; the template exists for user convenience.
    pub fn new(component_parameters: crate::models::ComponentOptions, description: String, name: String) -> EndpointTemplate {
        EndpointTemplate {
            component_parameters: Box::new(component_parameters),
            description,
            name,
        }
    }
