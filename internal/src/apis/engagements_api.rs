...
pub async fn create_engagement(configuration: &configuration::Configuration, create_engagement_request: crate::models::CreateEngagementRequest, x_qcs_account_id: Option<&str>, x_qcs_account_type: Option<crate::models::AccountType>) -> Result<crate::models::EngagementWithCredentials, Error<CreateEngagementError>> {
