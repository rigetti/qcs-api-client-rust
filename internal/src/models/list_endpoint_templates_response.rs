...
pub struct ListEndpointTemplatesResponse {
    #[serde(rename = "endpointTemplates")]
    pub endpoint_templates: Vec<crate::models::EndpointTemplate>,
}

impl ListEndpointTemplatesResponse {
    pub fn new(
        endpoint_templates: Vec<crate::models::EndpointTemplate>,
    ) -> ListEndpointTemplatesResponse {
        ListEndpointTemplatesResponse { endpoint_templates }
    }
}
