...
pub struct ListQuantumProcessorAccessorResponse {
    /// Methods of accessing the relevant Quantum Processor
    #[serde(rename = "accessors")]
    pub accessors: Vec<crate::models::QuantumProcessorAccessor>,
    /// Opaque token indicating the start of the next page of results to return; do not decode
    #[serde(rename = "nextPageToken", skip_serializing_if = "Option::is_none")]
    pub next_page_token: Option<String>,
}

impl ListQuantumProcessorAccessorResponse {
    pub fn new(
        accessors: Vec<crate::models::QuantumProcessorAccessor>,
    ) -> ListQuantumProcessorAccessorResponse {
        ListQuantumProcessorAccessorResponse {
            accessors,
