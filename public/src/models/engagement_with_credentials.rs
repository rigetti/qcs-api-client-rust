...
impl EngagementWithCredentials {
    ...
    pub fn new(address: String, credentials: crate::models::EngagementCredentials, endpoint_id: String, expires_at: String, user_id: String) -> EngagementWithCredentials {
