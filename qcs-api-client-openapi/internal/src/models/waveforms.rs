...
pub enum Waveforms {
    #[serde(rename = "HermiteGaussianWaveform")]
    HermiteGaussianWaveform(crate::models::HermiteGaussianWaveform),
    #[serde(rename = "DragGaussianWaveform")]
    DragGaussianWaveform(crate::models::DragGaussianWaveform),
    #[serde(rename = "GaussianWaveform")]
    GaussianWaveform(crate::models::GaussianWaveform),
    #[serde(rename = "ErfSquareWaveform")]
    ErfSquareWaveform(crate::models::ErfSquareWaveform),
    #[serde(rename = "FlatWaveform")]
    FlatWaveform(crate::models::FlatWaveform),
    #[serde(rename = "ArbitraryWaveform")]
    ArbitraryWaveform(crate::models::ArbitraryWaveform),
}
