...
pub struct LegacyNodeDescriptor {
    ...
    /// Mark the node as experimental, preventing its use during compilation except for experimental  users, even if 1Q gates exist. If omitted from the model, the interpretation is `experimental = False`.
    #[serde(rename = "experimental", skip_serializing_if = "Option::is_none")]
    pub experimental: Option<bool>,
}

impl LegacyNodeDescriptor {
    /// A single qubit node.
    pub fn new() -> LegacyNodeDescriptor {
