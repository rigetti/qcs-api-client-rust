...
#[cfg(feature = "tracing-opentelemetry")]
pub(crate) use trace_layer_otel_ext::{CustomTraceLayer, build_layer as build_trace_layer};

#[cfg(not(feature = "tracing-opentelemetry"))]
pub use trace_layer::CustomTraceService;
#[cfg(not(feature = "tracing-opentelemetry"))]
pub(crate) use trace_layer::{CustomTraceLayer, build_layer as build_trace_layer};
