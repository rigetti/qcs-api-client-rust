...
pub mod readout_values {
    #[derive(Clone, PartialEq, ::qcs_dependencies_client::prost::Oneof)]
    #[prost(prost_path = "::qcs_dependencies_client::prost")]
    pub enum Values {
        #[prost(message, tag = "1")]
...
pub struct IntegerReadoutValues {
    ...
    pub values: ::qcs_dependencies_client::prost::alloc::vec::Vec<i32>,
}
...
pub struct Complex64ReadoutValues {
    ...
    pub values: ::qcs_dependencies_client::prost::alloc::vec::Vec<Complex64>,
}
...
pub struct EncryptedControllerJob {
    ...
    pub job: ::qcs_dependencies_client::prost::alloc::vec::Vec<u8>,
...
pub struct JobEncryption {
    ...
    #[prost(string, tag = "1")]
    pub key_id: ::qcs_dependencies_client::prost::alloc::string::String,
    /// If relevant, the nonce to use in decryption
    #[prost(bytes = "vec", tag = "2")]
    pub nonce: ::qcs_dependencies_client::prost::alloc::vec::Vec<u8>,
}
#[derive(Clone, PartialEq, ::qcs_dependencies_client::prost::Message)]
#[prost(prost_path = "::qcs_dependencies_client::prost")]
...
pub struct BinaryDataValue {
    #[prost(bytes = "vec", tag = "1")]
    pub data: ::qcs_dependencies_client::prost::alloc::vec::Vec<u8>,
}
/// Signed integer value, corresponding to INTEGER in Quil.
#[derive(Clone, PartialEq, Eq, Hash, ::qcs_dependencies_client::prost::Message)]
#[prost(prost_path = "::qcs_dependencies_client::prost")]
pub struct IntegerDataValue {
    ...
    pub data: ::qcs_dependencies_client::prost::alloc::vec::Vec<i64>,
}
/// Real number value, corresponding to REAL in Quil.
#[derive(Clone, PartialEq, ::qcs_dependencies_client::prost::Message)]
#[prost(prost_path = "::qcs_dependencies_client::prost")]
pub struct RealDataValue {
    ...
    pub data: ::qcs_dependencies_client::prost::alloc::vec::Vec<f64>,
}
...
pub struct ControllerJobExecutionResult {
    ...
    pub status_message: ::core::option::Option<
        ::qcs_dependencies_client::prost::alloc::string::String,
    >,
