...
pub async fn internal_create_reservation(
    ...
    match internal_create_reservation_inner(
        configuration,
    ...
    .await
    {
        ...
        Err(err) => match err.status_code() {
            Some(StatusCode::FORBIDDEN | StatusCode::UNAUTHORIZED) => {
                configuration.qcs_config.refresh().await?;
                internal_create_reservation_inner(
                    configuration,
                    internal_create_reservation_request,
                    x_qcs_account_id,
                    x_qcs_account_type,
                )
                .await
...
pub async fn internal_find_available_reservations(
    ...
    Error<InternalFindAvailableReservationsError>,
> {
    match internal_find_available_reservations_inner(
        configuration,
        quantum_processor_id.clone(),
        start_time_from.clone(),
        duration.clone(),
    ...
    .await
    {
        ...
        Err(err) => match err.status_code() {
            Some(StatusCode::FORBIDDEN | StatusCode::UNAUTHORIZED) => {
                configuration.qcs_config.refresh().await?;
                internal_find_available_reservations_inner(
                    configuration,
                    quantum_processor_id,
                    start_time_from,
                    duration,
...
pub async fn internal_list_reservations(
    ...
    match internal_list_reservations_inner(
        configuration,
        filter.clone(),
        order.clone(),
        page_size.clone(),
    ...
    .await
    {
        ...
        Err(err) => match err.status_code() {
            Some(StatusCode::FORBIDDEN | StatusCode::UNAUTHORIZED) => {
                configuration.qcs_config.refresh().await?;
                internal_list_reservations_inner(
                    configuration,
                    filter,
                    order,
                    page_size,
