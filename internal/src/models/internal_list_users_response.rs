...
pub struct InternalListUsersResponse {
...
impl InternalListUsersResponse {
    pub fn new(next_page_token: String, users: Vec<crate::models::User>) -> InternalListUsersResponse {
