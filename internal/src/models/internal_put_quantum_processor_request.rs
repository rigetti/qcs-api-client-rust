...
pub struct InternalPutQuantumProcessorRequest {
    #[serde(rename = "quantumProcessor")]
    pub quantum_processor: Option<Box<serde_json::Value>>,
}
...
impl InternalPutQuantumProcessorRequest {
    pub fn new(quantum_processor: Option<serde_json::Value>) -> InternalPutQuantumProcessorRequest {
        InternalPutQuantumProcessorRequest {
            quantum_processor: if let Some(x) = quantum_processor {Some(Box::new(x))} else {None},
        }
    }
}
