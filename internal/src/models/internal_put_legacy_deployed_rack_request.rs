...
pub struct InternalPutLegacyDeployedRackRequest {
    #[serde(rename = "legacyDeployedRack")]
    pub legacy_deployed_rack: Box<crate::models::LegacyDeployedRack>,
}

impl InternalPutLegacyDeployedRackRequest {
    pub fn new(legacy_deployed_rack: crate::models::LegacyDeployedRack) -> InternalPutLegacyDeployedRackRequest {
        InternalPutLegacyDeployedRackRequest {
            legacy_deployed_rack: Box::new(legacy_deployed_rack),
        }
    }
}
