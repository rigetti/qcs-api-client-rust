...
pub struct GateSettings {
    ...
    pub program: Box<crate::models::ScheduledProgram>,
    #[serde(rename = "schedule_ir_name")]
    pub schedule_ir_name: String,
    #[serde(rename = "targets")]
    pub targets: Vec<i32>,
}

impl GateSettings {
    /// Information needed to schedule a gate from Quil.
    pub fn new(_type: String, program: crate::models::ScheduledProgram, schedule_ir_name: String, targets: Vec<i32>) -> GateSettings {
        GateSettings {
            _type,
