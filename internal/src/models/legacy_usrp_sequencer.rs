...
pub struct LegacyUsrpSequencer {
    #[serde(rename = "_type")]
    pub _type: String,
    #[serde(rename = "rx_channel", skip_serializing_if = "Option::is_none")]
    pub rx_channel: Option<String>,
    #[serde(rename = "tx_channel", skip_serializing_if = "Option::is_none")]
    pub tx_channel: Option<String>,
}

impl LegacyUsrpSequencer {
    /// Configuration for a Legacy USRP Sequencer.
    pub fn new(_type: String) -> LegacyUsrpSequencer {
        LegacyUsrpSequencer {
            _type,
            rx_channel: None,
            tx_channel: None,
