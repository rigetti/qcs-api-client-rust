...
impl Waveforms {
    pub fn new(_type: String, alpha: f32, anh: f32, detuning: f32, duration: f32, frame: String, fwhm: f32, phase: f32, scale: f32, second_order_hrm_coeff: f32, t0: f32, pad_left: f32, pad_right: f32, risetime: f32, iq: Vec<f32>) -> Waveforms {
        Waveforms {
            _type,
            alpha,
            anh,
