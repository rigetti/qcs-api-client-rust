...
impl UsiCardSequencer {
    /// Configuration for the card which interfaces with the USI Target on the USRP.
    pub fn new(_type: String, tx_channel: String) -> UsiCardSequencer {
        UsiCardSequencer { _type, tx_channel }
    }
}
