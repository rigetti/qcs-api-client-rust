...
pub struct LegacyQuantumProcessor {
    #[serde(rename = "isa")]
    ...
    /// The total number of qubits available on the device.
    #[serde(rename = "num_qubits")]
    pub num_qubits: i32,
    /// The rack and fridge identifier within which the device is mounted.
    #[serde(rename = "qpu_endpoint")]
    pub qpu_endpoint: String,
    #[serde(rename = "specs")]
    pub specs: Box<crate::models::Specs>,
}

impl LegacyQuantumProcessor {
    pub fn new(isa: crate::models::Isa, name: String, num_qubits: i32, qpu_endpoint: String, specs: crate::models::Specs) -> LegacyQuantumProcessor {
