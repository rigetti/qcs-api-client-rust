...
impl SetDefaultEndpointRequest {
    /// Request to set the default endpoint for a quantum processor.
    pub fn new() -> SetDefaultEndpointRequest {
        SetDefaultEndpointRequest { endpoint_id: None }
    }
}
