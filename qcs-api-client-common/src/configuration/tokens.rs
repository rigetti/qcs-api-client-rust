...
pub(super) struct RefreshTokenResponse {
    pub(super) refresh_token: SecretRefreshToken,
    pub(super) access_token: SecretAccessToken,
}
            ...
            .mock_async(|when, then| {
                ...
                then.status(200)
                    ...
                    .json_body_obj(&RefreshTokenResponse {
                        ...
                        refresh_token: SecretRefreshToken::from("new_refresh"),
                    });
            })
            .await;
...
"#
            ...
            rt.block_on(async {
                ...
                let issuer_mock = mock_server
                    .mock_async(|when, then| {
                        ...
                        then.status(200).json_body_obj(&RefreshTokenResponse {
                            ...
                            refresh_token: SecretRefreshToken::from(initial_refresh_token),
                        });
                    })
                    .await;
                ...
                let original_tokens = OAuthSession::from_refresh_token(
                    ...
                    AuthServer { client_id: "client_id".to_string(), issuer: mock_server.base_url() },
