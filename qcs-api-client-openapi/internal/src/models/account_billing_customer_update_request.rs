...
impl AccountBillingCustomerUpdateRequest {
    /// The billing customer represented by `id` must exist and not be assigned to any other QCS account. The server will ensure the billing customer has the appropriate metadata.
    pub fn new(id: String) -> AccountBillingCustomerUpdateRequest {
        AccountBillingCustomerUpdateRequest { id }
    }
}
